...
const navigation = [
  { name: "پروفایل", href: "/dashboard/settings/profile", icon: UserCircle },
  { name: "نقش‌های من", href: "/dashboard/settings/roles", icon: Shield },
  { name: "امنیت", href: "/dashboard/settings/security", icon: Fingerprint },
  { name: "حذف حساب کاربری", href: "/dashboard/settings/delete-account", icon: Trash2 },
];
